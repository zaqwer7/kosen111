...
<h2><?php  echo __('Comment'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($comment['Comment']['type']); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Type Num'); ?></dt>
		<dd>
			<?php echo h($comment['Comment']['type_num']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($comment['Comment']['extra1']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Extra2'); ?></dt>
		<dd>
			<?php echo h($comment['Comment']['extra2']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
