<div class="comments index">
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['type']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['created']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['modified']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['deleted']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['type_num']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($comment['User']['id'], array('controller' => 'users', 'action' => 'view', $comment['User']['id'])); ?>
		</td>
		<td><?php echo h($comment['Comment']['extra1']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['extra2']); ?>&nbsp;</td>
		<td class="actions">
